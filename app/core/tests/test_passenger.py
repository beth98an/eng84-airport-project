...
class PassengerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Passenger.objects.create(first_name="Jack", last_name="Rondon", dob="2022-04-08", passport_num="987654DEF")

    '''
    # Function(test) to check if a passenger(parent_class) exists in the database
    def test_passenger(self):
        passenger1 = Passenger.objects.get(id=1)
        ...
        passenger2 = Passenger.objects.get(id=2)
        self.assertEqual(passenger2.first_name, "Jack")
        self.assertEqual(passenger2.last_name, "Rondon")
        self.assertEqual(str(passenger2.dob), "1990-01-30")
        self.assertEqual(passenger2.passport_num, "987654DEF")

    '''
    '''
    # Function to check if a person(parent_class) exists in the database    
    ...
    # Function to check if a staff(children_class) exists in the database  
    def test_staff(self):
        staff1 = Staff.objects.get(id=1)
    ...
    # Function to check if a passenger with a day of birth in the future has been added in the database
    def test_bod(self):
        person_test = Passenger.objects.get(id=2)
